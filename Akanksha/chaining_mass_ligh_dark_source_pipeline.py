...
"""
path_prefix = path.join(workspace_path, "Akanksha","SLACS1_OtherPipeline_output")
...
bulge.centre.centre_0 = af.GaussianPrior(
    mean=0.0, sigma=0.1, lower_limit=-5.0, upper_limit=5.0
)
...
dataset_name = 'SLACS1_NewPipeline'
...
model = af.Collection(
    galaxies=af.Collection(
        lens=af.Model(
            ...
            bulge=bulge,
            disk=disk,
            dark=dark,#af.Model(al.mp.EllNFW),
